...
async function carregarClientesOS() {
  const { data, error } = await supabaseClient.from('clientes').select('id,nome,unidade,telefone,email').order('nome');
